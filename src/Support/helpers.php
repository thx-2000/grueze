...
function icon(string $name): string
{
    $icons = [
        ...
        'message-send' => '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 5h15A1.5 1.5 0 0 1 21 6.5v8A1.5 1.5 0 0 1 19.5 16H8.4l-3.9 3v-3H4.5A1.5 1.5 0 0 1 3 14.5v-8A1.5 1.5 0 0 1 4.5 5Zm2.2 3.7l4.1 2.9a2 2 0 0 0 2.3 0l4.2-2.9l-1.1-1.4L12 10.2L7.8 7.3L6.7 8.7Zm11.05 10.95l-1.4-1.4l1.05-1.02H13v-2h4.4l-1.05-1.02l1.4-1.4L21.2 16l-3.45 3.65Z"/></svg>',
