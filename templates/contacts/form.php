...
<section class="hero-card">
    ...
    <form method="post" action="<?= e(url($editing ? '/contacts/update' : '/contacts/store')) ?>" enctype="multipart/form-data" class="stack">
        ...
        <div class="form-grid">
            ...
            <label><span>Straße</span><input type="text" name="strasse" value="<?= e($values['strasse'] ?? '') ?>" required></label>
            ...
            <label class="full-width"><span>Profilbild</span><input type="file" name="photo" accept=".jpg,.jpeg,.png,.webp"></label>
