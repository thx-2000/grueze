                ...
                <li class="events-row">
                    <a class="events-row-main" href="<?= e(url('/verwaltung/gruppen/detail?id=' . (int) $group['id'])) ?>">
                        ...
                        <span class="events-row-meta">
                            ...
                            <?php if ((int) ($group['pending_requests'] ?? 0) > 0): ?><span class="events-status is-open"><?= (int) $group['pending_requests'] ?> Anfrage<?= (int) $group['pending_requests'] === 1 ? '' : 'n' ?></span> · <?php endif; ?>
