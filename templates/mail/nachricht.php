...
<header class="msg-head">
    ...
    <p class="field-hint">
        <a href="<?= e(url('/rundmail/verlauf')) ?>">Gesendete Nachrichten ansehen &amp; erneut verschicken →</a>
        <?php if ($eventId === null && !$hasPreset): ?>
            · <a href="<?= e(url('/gruesse/weihnachten')) ?>">Weihnachtsgrüße gemischt verschicken →</a>
        <?php endif; ?>
    </p>
</header>
